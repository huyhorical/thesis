...
public class ProvinceDialog extends DialogFragment{
    ...
    @SuppressLint("ValidFragment")
    public ProvinceDialog(List<SicknessCategory> categories, OnAnswerListener onAnswerListener){
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        tvQuestion.setText("Vui lòng khu vực:");
        ...
        builder.setTitle("Nơi tiêm chủng...");
